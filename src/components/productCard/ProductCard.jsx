      ...
      <div className="container px-5 py-8 md:py-16 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          {/* {products
            ...
            {products?.filter((data) => data.title.toLowerCase().includes(searchkey))?.
            filter((data) =>data.category.toLowerCase().includes(filterType))
            // ?.filter((data) => data.price === filterPrice)
            .slice(0,8)
            ?.map((item, index) => { 
